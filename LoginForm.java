...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/3586362_checklist_document_list_paper_icon (1).png"))); // NOI18N

        Tk.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(Tk)
                                    .addComponent(Mk, javax.swing.GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE))
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
       if(Tk.getText().isEmpty()|| Mk.getText().isEmpty())
       {
        JOptionPane.showMessageDialog(this, "Thieu thong tin");
       }
       else{
           String Querry = "select * from quanlykho.user where Taikhoan='"+Tk.getText()+"'and Matkhau='"+Mk.getText()+"'";
        try{
